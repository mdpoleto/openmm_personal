#!/usr/bin/python
###########################################
# Runs a NPT equilibration with CHARMM36m FF after NVT.
#
# Outputs DCD files, last frame (CRD) and RST files with positions and
# velocities. Requires a PSF, a CRD and a RST. It allows restarting a
...
print("\t- Reading equilibration state...")
