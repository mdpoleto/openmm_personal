#!/usr/bin/python
###########################################
# Runs a NVT equilibration with CHARMM36m FF.
#
...
# Options
ap.add_argument('-outname', type=str, default="output.c36.nvt",
...
with open('Equilibration_NVT.dat', 'w') as out:
...
print("\tPressure = " + str(pressure) + " (NVT ensemble)")
...
print("\n> NVT Equilibration! Let's do this:\n")
print("\n> Setting the system:\n")
...
print("\t- Energy minimization: 5000 steps")
simulation.minimizeEnergy(tolerance=10*kilojoule/mole, maxIterations=5000)
print("\t-> " + str(simulation.context.getState(getEnergy=True).getPotentialEnergy()))

print("\t- Setting velocities...")
# Termostat is set in the DrudeLangevinIntegrator
...
if os.path.exists(chk_file):
	...
	backup_file = backup_old_log("*" + jobname + ".NVT.log*", jobname + ".NVT.log")
